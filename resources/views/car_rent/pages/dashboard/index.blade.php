  ...
  <div class="container-xxl flex-grow-1 container-p-y">
    ...
    <div class="col-lg-8 mb-4 order-0">
      ...
      <div class="d-flex align-items-end row">
        <div class="col-sm-7">
        <div class="card-body">
          <h5 class="card-title text-primary">   {{ auth()->user()->name }} اهلا🎉</h5>
          <p class="mb-4">
         يمكنك اضافة سيارة جديدة من هنا
          </p>

          <a href="{{ route('cars.create') }}" class="btn btn-sm btn-outline-primary">اضافة سيارة</a>
        </div>
        </div>
