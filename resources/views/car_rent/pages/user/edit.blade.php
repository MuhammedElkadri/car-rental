          ...
          <div class="card mb-4">
            ...
            <div class="card-body">
              <form>
                ...
                <div class="row mb-3">
                  <label class="col-sm-3 col-form-label" for="basic-icon-default-company">Company</label>
                  <div class="col-sm-9">
                    <div class="input-group input-group-merge">
                ...
                <div class="row mb-3">
                  <label class="col-sm-3 form-label" for="basic-icon-default-phone">Phone No</label>
                  <div class="col-sm-9">
                    <div class="input-group input-group-merge">
